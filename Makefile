...
.PHONY: ensure-runtime-base build-runtime-base reset-oracle-db up up-ollama up-oracle-db down logs ps rebuild migrate shell test-postgres-integration test-oracle-integration
