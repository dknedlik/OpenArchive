...
.PHONY: ensure-runtime-base build-runtime-base reset-oracle-db up up-ollama up-oracle-db up-qdrant down logs ps rebuild migrate shell status verify install-qdrant test-postgres-integration test-oracle-integration
